...
<h2 align='center'>All Orders</h2>
	<button onclick="window.location.href='print_form.php?type=all'">Print</button><p>
<div class="table-responsive">
<table class="table table-striped table-bordered table-hover">
	<tr>
		<td><h4>Employee Name</h4></td><td><h4>Requestor</h4></td><td><h4>Date Requested</h4></td><td><h4>Date Completed</h4></td>
</tr>
