...
$i = 1;
$returned_date = $_POST['Returned'];
$newDate = date("F j, Y", strtotime($returned_date));
...
?>
<h3>The following business cards were returned from the printer on <? echo $newDate ?></h3>
<br>
<br>
...
$insert_sql="UPDATE `Orders` SET `recdFmPrinter`='1' ,`dateFmPrinter` = '" . $returned_date . "'  WHERE `idOrders` IN (";
